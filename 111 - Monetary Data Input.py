...
Create a package called UTILITIES that has two internal modules called:
Currency and Data

Transfer all functions used in challenges 107, 108 and 109 to the first package
and keep everything working. '''


''' Right-click on folder 111 and create two packages, one named Currency and 
the other Data. Then copy the code from the currency file and paste it into 
the __init__.py file of the Currency package, after which you can delete the 
file outside the package. We will do the same for the Data package, 
but in the next exercise '''
